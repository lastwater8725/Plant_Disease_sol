...
def label_description():
    ...
    return label_decoder, label_encoder

label_encoder, label_decoder = label_description()
print(f'Label Encoder 개수: {len(label_encoder)}')
print(f'Label decoder 개수: {len(label_decoder)}')